    ...
    <div className="logo-wrapper">
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="65" viewBox="0 0 131.708 118.625">
        ...
        <g transform="translate(-26.75 -24.625)">
          ...
          <circle cx="63.441" cy="86.904" r="3.157" fill="#000b00" stroke="rgb(70, 89, 97)" strokeWidth="7" />
          <path d="M65.991 100.317c20.586 17.152 37.668 13.675 53.017 0-16.437 15.76-34.157 15.148-53.017 0z" fill="none" stroke="rgb(70, 89, 97)" strokeWidth="6" />
          <circle r="3.157" cy="86.637" cx="122.507" fill="#000b00" stroke="rgb(70, 89, 97)" strokeWidth="7" />
